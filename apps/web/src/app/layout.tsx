...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const title = "VeriFi — Verifiable RWA Yield";
  const description = "AI-assisted evidence extraction with deterministic, challengeable settlement on BOT Chain.";
  return {
    metadataBase,
    title,
    description,
    openGraph: { title, description, type: "website", images: [{ url: "/og-v2.png", width: 1731, height: 909, alt: "VeriFi — Make real-world yield prove itself." }] },
